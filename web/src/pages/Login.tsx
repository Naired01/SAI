    ...
    <div className="min-h-screen grid place-items-center bg-slate-100 dark:bg-slate-950">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">{t('auth.login.title')}</p>
        </div>
        ...
        {err && (
          <div className="text-sm text-red-700 bg-red-50 border border-red-200 rounded-lg px-3 py-2 dark:bg-red-950/40 dark:border-red-900 dark:text-red-300">
            {err}
          </div>
        )}
